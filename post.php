 ...
 function add_comment(){
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            // $post_view_count_query="UPDATE posts SET post_view_count=post_view_count + 1 WHERE post_id=$post_id";
            // $send_query=mysqli_query($connection, $post_view_count_query);
            // if(!$send_query){
...
?>
                ...
                <!-- First Blog Post -->
                <h2>
                Posts with Title <?php echo $post_title ?></a>
                </h2>
                <p class="lead">
