        ...
        <div class="row">
           ...
           $cat_id= $_GET['category'];
                ...
                ?>
                    ...
                    Posts relating to <?php echo $cat_title ?>
            ...
            if(isset($_GET['category'])){
                ...
                if(isset($_SESSION['username'] )&& is_admin($_SESSION['username'])){
                    ...
                    $query1="SELECT * FROM posts WHERE post_category_id={$cat_id} ORDER BY post_id DESC  LIMIT $page_1, $per_page";
                }else{
                    $query="SELECT * FROM posts WHERE post_category_id={$cat_id} AND post_status='published' ORDER BY post_id DESC";
               
                    $query1="SELECT * FROM posts WHERE post_category_id={$cat_id} AND post_status='published' ORDER BY post_id DESC LIMIT $page_1, $per_page";
        ...
        <ul class="pager">
            <li>
                ...
                for($x=1; $x<=$post_count; $x++){
                    if($x==$page){
                        echo"<a style='background:#000' href='category.php?category={$post_cat_id}&page={$x}'>{$x}</a>";
                    }else{
                        echo"<a href='category.php?category={$post_cat_id}&page={$x}'>{$x}</a>";
                    }
